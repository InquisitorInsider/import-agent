...
4. Comprueba: `http://IP_DEL_OMV:8095/health` y abre el panel en
   `http://IP_DEL_OMV:8095`.
5. En el panel: pestaña **Importaciones → Guardar origen → Importación masiva**.

### Detalles de este compose (ya vienen resueltos)

- **Puerto `8095:8000`**: el 8000 ya está ocupado en tu OMV (igual que con
  print-agent). Acceso por `http://IP_OMV:8095`.
